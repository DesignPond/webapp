                                    ...
                                    <dl class="dl-horizontal">
                                        ...
                                        <?php
                                            ...
                                            if ($dates)
                                            {
                                                ...
                                                $valable = 'Valable du '.$start.' au '.$end;
                                            }
                                        ?>
                                        ...
                                        @foreach($group_type_data[$group] as $type_data_id)
                                            ...
                                            @if( isset($groupe_label[$type_data_id]) && !empty($groupe_label[$type_data_id]) )
                                                ...
                                                <dd>{{ $groupe_label[$type_data_id] }}</dd>

                                            @elseif(isset($isGroupe[$group]) && isset($alllabels[$isGroupe[$group]][$type_data_id]) && !empty($group_type_data[$isGroupe[$group]][$type_data_id]) )
                                                <dt>{{ trans('label.label_'.$type_data_id) }}</dt>
                                                <dd>
                                                    {{ $alllabels[$isGroupe[$group]][$type_data_id] }}
                                                    <span class="pull-right">{{ $valable }}</span>
                                                </dd>
