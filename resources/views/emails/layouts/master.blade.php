...
<head>
    ...
    <title>{{ trans('menu.welcome') }}</title>
    <style type="text/css">
        /* Modified:30/10/2014 */
        /* Global Reset */
        ...
        .eHeader_stretch, .eBody_stretch, .eFooter_stretch {
            min-width: 16px;
        }
        ...
        h1, h1 span, h2, h2 span, .invoiceHead .ihBlack, span.serviceName {
            color: #465059;
        }
        ...
        .highlight, .bubble td, .bubble table td, .invoiceTable2 .subTotal, .priceColumn th, .priceColumn.recommend td, .highlight_stretch {
        ...
        @media only screen and (max-width: 576px) {
            td[class=eHeader_stretch], td[class=highlight_stretch], td[class=eBody_stretch], td[class=eFooter_stretch] {
        ...
        @media only screen and (max-width: 560px) {
            ...
            table[id=emailBody], td[class=emailBodyCell], table[class=eBox], td[class=highlight], td[class~=highlight], td[class=eBody], td[class~=eBody], td[class=blank], div[class=bannerLink] a, div[class=bannerLink] img {
                display: block !important;
                width: auto !important;
            }
        ...
        <td align="center" valign="top" class="emailBodyCell" style="{{ $marginReset }}padding-top: 0;padding-bottom: 32px;padding-left: 0;padding-right: 0;border-collapse: collapse;border-spacing: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;height: 100%;width: 100%;background-color: #ebebeb;">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="eBox" style="{{ $marginReset }}{{ $paddingReset }}mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-collapse: collapse;border-spacing: 0;width: 100%;min-width: 576px;">
                ...
                <tr>
                    ...
                    <td class="eFooter" style="{{ $marginReset }}padding-top: 14px;padding-bottom: 0;padding-left: 0;padding-right: 0;border-collapse: collapse;border-spacing: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;text-align: center;font-size: 12px;line-height: 21px;width: 544px;color: #b2b2b2;">
                        © {{ date('Y') }} RiiingMe. All Rights Reserved.
                    </td>
                    <td class="eFooter_stretch" style="{{ $reset }}min-width: 16px;">&nbsp;</td>
                </tr>
            </table>
